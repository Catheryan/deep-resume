...
\vspace{0.1em}
\begin{tightemize}
    \item owner主要利用\textbf{Kotlin Multiplatform}技术栈，提供跨端的链式点击处理能力
    \item 节点组合能力，逻辑统一，提供链式点击跳转能力 \textbf{线上稳定运行，便于业务排查}
    \end{tightemize}
\sectionsep
...
\vspace{0.1em}
\begin{tightemize}
    \item 基于页面维度触发站内信消息，提供跨进程\textbf{main和web}的页面触达能力
    \item 同时也在探索基于端智能能力探索，提供更好的策略方式
    \end{tightemize}
\sectionsep
...
\begin{tightemize}
    ...
    \item 设计提供config方案，平稳从web过度到Native渠道能力
    \end{tightemize}
\sectionsep
...
\vspace{0.1em}
\begin{tightemize}
    \item 主要利用Flutter的跨端能力，提供页面能力
    \item 搭建Futter生态，包含基础组件以及cd能力
    \end{tightemize}
\sectionsep
...
\vspace{0.1em}
\begin{tightemize}
    \item 主要利用ksp以及dag的能力，构建首页启动流程
    \item 通过任务的依赖关系，优化启动流程
    \end{tightemize}
\sectionsep
